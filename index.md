...
<p>Hi, I’m Eldon, and welcome to my portfolio. My goal is to help teams reduce downtime and operational risk. I build, secure, troubleshoot, and document Windows, Linux, and hybrid infrastructure so teams can manage, operate, and recover systems consistently. With 250+ artifacts, each project follows a structured process from planning through validation and documentation.
...
<a href="/portfolio/" class="btn" style="padding:10px 20px; border:1px solid #fff; color:#fff; text-decoration:none; border-radius:5px; font-weight:bold; margin-right:10px;">
