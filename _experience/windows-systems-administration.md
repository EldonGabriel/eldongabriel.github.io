...
<div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
  ...
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
    ...
    <figcaption>REPORT – Secure Credential Entry via Group Policy – v1.0.0</figcaption>
  </figure>
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
    ...
    <figcaption>REPORT – System Hardening via Local GPO: Restricting Anonymous Connections – v1.0.0</figcaption>
  </figure>
  ...
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
    ...
    <figcaption>REPORT – System Hardening via Local GPO: Windows Defender – v1.0.0</figcaption>
  </figure>
