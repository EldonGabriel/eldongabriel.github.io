...
<div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
  ...
  <!-- Row 3 -->
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
    <iframe src="{{ '/assets/guides/GUIDE – RDP Troubleshooting for AWS Users – v1.0.0.pdf' | relative_url }}" width="100%" height="800px" style="border:1px solid #ccc;"></iframe>
  ...
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
   ...
   <!-- Row 6 -->
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
    <iframe src="{{ 'assets/guides/GUIDE – System Activity Reporter (SAR) Performance Monitoring on Ubuntu 24.04.3 LTS – v1.0.0.pdf' | relative_url }}" width="100%" height="800px" style="border:1px solid #ccc;"></iframe>
    <figcaption>GUIDE – System Activity Reporter (SAR) Performance Monitoring on Ubuntu 24.04.3 LTS – v1.0.0</figcaption>
  </figure>
  <figure style="flex: 1 1 calc(50% - 20px); min-width: 400px; max-width: 600px; text-align: center;">
    <iframe src="{{ 'assets/guides/GUIDE – Backup and Restore Using Duplicati CLI – v1.0.0.pdf' | relative_url }}" width="100%" height="800px" style="border:1px solid #ccc;"></iframe>
    <figcaption>GUIDE – Backup and Restore Using Duplicati CLI – v1.0.0.pdf</figcaption>
  </figure>
