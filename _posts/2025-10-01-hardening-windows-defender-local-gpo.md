...
<iframe
src="{{ '/assets/reports/REPORT – System Hardening via Local GPO_ Windows Defender – v1.0.0.pdf' | relative_url }}"
width="100%"
height="680"
...
<strong>REPORT – System Hardening via Local GPO_ Windows Defender – v1.0.0</strong>
</p>
