...
<iframe
src="{{ '/assets/guides/GUIDE – Security Control Standard_ AC-6 Least Privilege (NIST SP 800-53) – v1.0.2.pdf' | relative_url }}"
width="100%"
height="680"
...
<strong>GUIDE – Security Control Standard_ AC-6 Least Privilege (NIST SP 800-53) – v1.0.2</strong>
</p>
</div>
