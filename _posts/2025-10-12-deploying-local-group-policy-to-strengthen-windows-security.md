...
<iframe
src="{{ '/assets/reports/REPORT – Deploy Local GPO for Windows Security Policies – v1.0.0.pdf' | relative_url }}"
width="100%"
height="680"
...
<strong>REPORT – Deploy Local GPO for Windows Security Policies – v1.0.0</strong>
</p>
