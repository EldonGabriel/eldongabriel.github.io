...
* **Layer 3 Validation**
  - Verified external connectivity using IP-based testing (`ping 8.8.8.8`), confirming gateway routing and NAT functionality.
  - Observed failure when using domain names, isolating the issue to DNS resolution.
