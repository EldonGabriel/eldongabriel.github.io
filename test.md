...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
  <figure style="flex: 1; min-width: 300px; max-width: 600px; text-align: center;">
    <iframe class="pdf-embed" 
            ...
            width="100%" height="600px" style="border:1px solid #333; border-radius:8px;"></iframe>
...
<div style="display: flex; align-items: center; flex-direction: row-reverse; margin-bottom: 40px;">
  <div style="flex: 1; text-align: center;">
    <img src="assets/images/eldon-alex.png" alt="Alex Clark" 
         style="width:250px; height:250px; object-fit: cover; border-radius:50%;"><br>
...
<div style="display: flex; align-items: center; margin-bottom: 40px;">
  <div style="flex: 1; text-align: center;">
    <img src="assets/images/eldon-stedman.png" alt="Stedman Graham" 
         style="width:250px; height:250px; object-fit: cover; border-radius:50%;"><br>
